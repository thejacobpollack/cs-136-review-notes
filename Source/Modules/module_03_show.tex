...
\exerbox{Write a structure for a box, with parameters for width, length and height.}
\exerbox{Using the structure for a box, write a function that calculates the area and volume of a box.}
